...
;;;;; basic coloring
   ...
   `(fringe ((t (:foreground ,zenburn-fg :background ,zenburn-bg-fringe))))
   `(header-line ((t (:foreground ,zenburn-yellow
                                  :background ,zenburn-bg-z
                                  :box nil))))
...
;;;;; helm
   ...
   `(helm-source-header
     ((t (:foreground ,zenburn-yellow
                      ...
                      :weight bold
                      :box nil))))
   `(helm-selection ((t (:background ,zenburn-bg+05 :underline nil))))
   `(helm-selection-line ((t (:background ,zenburn-bg+05))))
...
;;;;; powerline
   ...
   `(powerline-inactive2 ((t (:background ,zenburn-bg+2 :inherit mode-line-inactive))))
;;;;; proofgeneral
